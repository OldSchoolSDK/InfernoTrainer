...
export class Collision {
  ...
  static collidesWithUnitAtPerceivedDisplayLocation(x: number, y: number, tickPercent: number, unit: Unit) {
    const perceivedX = Pathing.linearInterpolation(
      unit.perceivedLocation.x * Settings.tileSize,
      unit.location.x * Settings.tileSize,
      tickPercent,
    );
    const perceivedY = Pathing.linearInterpolation(
      unit.perceivedLocation.y * Settings.tileSize,
      unit.location.y * Settings.tileSize,
      tickPercent,
    );
